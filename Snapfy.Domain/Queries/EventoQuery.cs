...
namespace Shoalace.Domain.Queries
{
    public static class EventoQuery
    {
        ...
        public static Expression<Func<Evento, bool>> ObterPor2Usuarios(long usuarioId, long contatoId) =>
            e => e.MembrosEvento != null && e.GrupoId == null && e.Data >= DateTime.Now.AddHours(-5) && e.MembrosEvento.Count() == 2 && e.MembrosEvento.Any(m => m.UsuarioId == contatoId) && e.MembrosEvento.Any(m => m.UsuarioId == usuarioId);
